...
<head>
  ...
  <title>Contact us | Empowering Tomorrow</title>
</head>
...
<body>
  ...
  <main>
    <!-- hero section -->
    <section class="w-full h-[50vh] md:h-[calc(100vh-80px)] relative contact-us-bg bg-center bg-cover">
      <div class="bg-gradient-to-bl from-transparent to-black/50 absolute top-0 left-0 w-full h-full z-10"></div>
    </section>
    <section>
      <div class="py-8 flex items-center flex-col">
        <div class="flex items-center flex-col">
          <h1 class="text-4xl text-center opacity-60 font-semibold">
        ...
        <div class="py-4">
          <p class="max-w-4xl text-center text-xl md:text-2xl font-semibold text-green-500">
            You can email us on <br />
            <span class="w-full inline-flex flex-wrap justify-center">
        ...
        <div class="py-4">
          <p class="max-w-4xl text-2xl font-light text-center">
            You can alternatively fill this form and get in touch with us.
          </p>
          <form class="py-8 px-4">
            <div class="flex gap-4 flex-col md:flex-row mb-4">
              <input type="text" name="first-name" id="first-name" placeholder="First Name"
                class="border border-gray-400 rounded-md p-4 md:mb-4 w-full md:w-auto" />
          ...
          <div class="flex items-center flex-col">
            <strong class="text-2xl font-semibold text-green-700">
              Follow us on
            </strong>
